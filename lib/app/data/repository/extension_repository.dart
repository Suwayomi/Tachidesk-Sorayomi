...
class ExtensionRepository {
  ...
  Future installExtension(String pkgName) =>
      _extensionProvider.installExtension(pkgName);
  Future updateExtension(String pkgName) =>
      _extensionProvider.updateExtension(pkgName);
  Future uninstallExtension(String pkgName) =>
      _extensionProvider.uninstallExtension(pkgName);
  Future installExtensionFile(File file) =>
