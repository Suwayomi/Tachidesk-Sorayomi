...
class CodegenLoader extends AssetLoader{
  ...
  "browserSettingsScreen": {
    "nsfw": {
      "info": "This does not prevent unofficial or potentially incorrectly flagged extensions from surfacing NSFW(18+) content within app",
  ...
  "editCategoriesScreen": {
    ...
    "name": "Category Name",
    "emptyCategory": "You have no Categories. Tap the Plus button to create one for organizing your library"
  },
  "error": {
    "filePick": "File not selected!",
    "filePickUnknownExtension": "Please select a file with {extensionName} extension",
