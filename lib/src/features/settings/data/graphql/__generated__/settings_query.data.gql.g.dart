...
Serializer<GServerSettingsData> _$gServerSettingsDataSerializer =
    new _$GServerSettingsDataSerializer();
Serializer<GServerSettingsData_settings>
    _$gServerSettingsDataSettingsSerializer =
    new _$GServerSettingsData_settingsSerializer();
Serializer<GSettingsFragmentData> _$gSettingsFragmentDataSerializer =
    new _$GSettingsFragmentDataSerializer();

class _$GServerSettingsDataSerializer
    implements StructuredSerializer<GServerSettingsData> {
  @override
  ...
  @override
  final String wireName = 'GServerSettingsData';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GServerSettingsData object,
    ...
    final result = <Object?>[
      ...
      serializers.serialize(object.settings,
          specifiedType: const FullType(GServerSettingsData_settings)),
    ];
  ...
  @override
  GServerSettingsData deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GServerSettingsDataBuilder();
      ...
      switch (key) {
        ...
        case 'settings':
          result.settings.replace(serializers.deserialize(value,
                  specifiedType: const FullType(GServerSettingsData_settings))!
              as GServerSettingsData_settings);
          break;
      }
    }
...
class _$GServerSettingsData_settingsSerializer
    implements StructuredSerializer<GServerSettingsData_settings> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  final String wireName = 'GServerSettingsData_settings';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GServerSettingsData_settings object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      '__typename',
      serializers.serialize(object.G__typename,
  ...
  @override
  GServerSettingsData_settings deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GServerSettingsData_settingsBuilder();
...
class _$GSettingsFragmentDataSerializer
    implements StructuredSerializer<GSettingsFragmentData> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  final String wireName = 'GSettingsFragmentData';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GSettingsFragmentData object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      '__typename',
      serializers.serialize(object.G__typename,
  ...
  @override
  GSettingsFragmentData deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
...
class _$GServerSettingsData extends GServerSettingsData {
  @override
  final String G__typename;
  @override
  final GServerSettingsData_settings settings;

  factory _$GServerSettingsData(
          [void Function(GServerSettingsDataBuilder)? updates]) =>
      (new GServerSettingsDataBuilder()..update(updates))._build();

  _$GServerSettingsData._({required this.G__typename, required this.settings})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        G__typename, r'GServerSettingsData', 'G__typename');
    BuiltValueNullFieldError.checkNotNull(
        settings, r'GServerSettingsData', 'settings');
  }

  @override
  GServerSettingsData rebuild(
          void Function(GServerSettingsDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GServerSettingsDataBuilder toBuilder() =>
      new GServerSettingsDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GServerSettingsData &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GServerSettingsData')
...
class GServerSettingsDataBuilder
    implements Builder<GServerSettingsData, GServerSettingsDataBuilder> {
  _$GServerSettingsData? _$v;

  String? _G__typename;
  String? get G__typename => _$this._G__typename;
  set G__typename(String? G__typename) => _$this._G__typename = G__typename;

  GServerSettingsData_settingsBuilder? _settings;
  GServerSettingsData_settingsBuilder get settings =>
      _$this._settings ??= new GServerSettingsData_settingsBuilder();
  set settings(GServerSettingsData_settingsBuilder? settings) =>
      _$this._settings = settings;

  GServerSettingsDataBuilder() {
    GServerSettingsData._initializeBuilder(this);
  }

  GServerSettingsDataBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(GServerSettingsData other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GServerSettingsData;
  }

  @override
  void update(void Function(GServerSettingsDataBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GServerSettingsData build() => _build();

  _$GServerSettingsData _build() {
    _$GServerSettingsData _$result;
    try {
      _$result = _$v ??
          new _$GServerSettingsData._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GServerSettingsData', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GServerSettingsData_settings extends GServerSettingsData_settings {
  @override
  final String G__typename;
  @override
  ...
  factory _$GServerSettingsData_settings(
      ...
      (new GServerSettingsData_settingsBuilder()..update(updates))._build();

  _$GServerSettingsData_settings._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        backupTTL, r'GServerSettingsData_settings', 'backupTTL');
    BuiltValueNullFieldError.checkNotNull(
    ...
    BuiltValueNullFieldError.checkNotNull(socksProxyEnabled,
        r'GServerSettingsData_settings', 'socksProxyEnabled');
    BuiltValueNullFieldError.checkNotNull(
        socksProxyHost, r'GServerSettingsData_settings', 'socksProxyHost');
    BuiltValueNullFieldError.checkNotNull(socksProxyPassword,
        r'GServerSettingsData_settings', 'socksProxyPassword');
    BuiltValueNullFieldError.checkNotNull(
        socksProxyPort, r'GServerSettingsData_settings', 'socksProxyPort');
    BuiltValueNullFieldError.checkNotNull(socksProxyUsername,
        r'GServerSettingsData_settings', 'socksProxyUsername');
    BuiltValueNullFieldError.checkNotNull(socksProxyVersion,
        r'GServerSettingsData_settings', 'socksProxyVersion');
    BuiltValueNullFieldError.checkNotNull(flareSolverrEnabled,
        r'GServerSettingsData_settings', 'flareSolverrEnabled');
    BuiltValueNullFieldError.checkNotNull(flareSolverrSessionName,
        r'GServerSettingsData_settings', 'flareSolverrSessionName');
    BuiltValueNullFieldError.checkNotNull(flareSolverrSessionTtl,
        r'GServerSettingsData_settings', 'flareSolverrSessionTtl');
    BuiltValueNullFieldError.checkNotNull(flareSolverrTimeout,
        r'GServerSettingsData_settings', 'flareSolverrTimeout');
    BuiltValueNullFieldError.checkNotNull(
        flareSolverrUrl, r'GServerSettingsData_settings', 'flareSolverrUrl');
    BuiltValueNullFieldError.checkNotNull(
        debugLogsEnabled, r'GServerSettingsData_settings', 'debugLogsEnabled');
    BuiltValueNullFieldError.checkNotNull(systemTrayEnabled,
        r'GServerSettingsData_settings', 'systemTrayEnabled');
    BuiltValueNullFieldError.checkNotNull(gqlDebugLogsEnabled,
        r'GServerSettingsData_settings', 'gqlDebugLogsEnabled');
    BuiltValueNullFieldError.checkNotNull(
        extensionRepos, r'GServerSettingsData_settings', 'extensionRepos');
  ...
  @override
  GServerSettingsData_settings rebuild(
          void Function(GServerSettingsData_settingsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GServerSettingsData_settingsBuilder toBuilder() =>
      new GServerSettingsData_settingsBuilder()..replace(this);
...
class GServerSettingsData_settingsBuilder
    implements
        Builder<GServerSettingsData_settings,
            GServerSettingsData_settingsBuilder> {
  _$GServerSettingsData_settings? _$v;
  ...
  GServerSettingsData_settingsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _G__typename = $v.G__typename;
  ...
  @override
  void replace(GServerSettingsData_settings other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GServerSettingsData_settings;
  }

  @override
  void update(void Function(GServerSettingsData_settingsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GServerSettingsData_settings build() => _build();

  _$GServerSettingsData_settings _build() {
    _$GServerSettingsData_settings _$result;
    try {
      _$result = _$v ??
          new _$GServerSettingsData_settings._(
              G__typename: BuiltValueNullFieldError.checkNotNull(
                  G__typename, r'GServerSettingsData_settings', 'G__typename'),
              ...
              socksProxyPort: BuiltValueNullFieldError.checkNotNull(socksProxyPort, r'GServerSettingsData_settings', 'socksProxyPort'),
              socksProxyUsername: BuiltValueNullFieldError.checkNotNull(socksProxyUsername, r'GServerSettingsData_settings', 'socksProxyUsername'),
              socksProxyVersion: BuiltValueNullFieldError.checkNotNull(socksProxyVersion, r'GServerSettingsData_settings', 'socksProxyVersion'),
              flareSolverrEnabled: BuiltValueNullFieldError.checkNotNull(flareSolverrEnabled, r'GServerSettingsData_settings', 'flareSolverrEnabled'),
              flareSolverrSessionName: BuiltValueNullFieldError.checkNotNull(flareSolverrSessionName, r'GServerSettingsData_settings', 'flareSolverrSessionName'),
              flareSolverrSessionTtl: BuiltValueNullFieldError.checkNotNull(flareSolverrSessionTtl, r'GServerSettingsData_settings', 'flareSolverrSessionTtl'),
              flareSolverrTimeout: BuiltValueNullFieldError.checkNotNull(flareSolverrTimeout, r'GServerSettingsData_settings', 'flareSolverrTimeout'),
              flareSolverrUrl: BuiltValueNullFieldError.checkNotNull(flareSolverrUrl, r'GServerSettingsData_settings', 'flareSolverrUrl'),
              debugLogsEnabled: BuiltValueNullFieldError.checkNotNull(debugLogsEnabled, r'GServerSettingsData_settings', 'debugLogsEnabled'),
              systemTrayEnabled: BuiltValueNullFieldError.checkNotNull(systemTrayEnabled, r'GServerSettingsData_settings', 'systemTrayEnabled'),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GServerSettingsData_settings', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GSettingsFragmentData extends GSettingsFragmentData {
  @override
  final String G__typename;
  @override
  final int backupInterval;
  ...
  factory _$GSettingsFragmentData(
      ...
      (new GSettingsFragmentDataBuilder()..update(updates))._build();

  _$GSettingsFragmentData._(
      {required this.G__typename,
      required this.backupInterval,
      required this.backupPath,
      required this.backupTTL,
    ...
    BuiltValueNullFieldError.checkNotNull(
        backupInterval, r'GSettingsFragmentData', 'backupInterval');
    BuiltValueNullFieldError.checkNotNull(
        backupPath, r'GSettingsFragmentData', 'backupPath');
    BuiltValueNullFieldError.checkNotNull(
        backupTTL, r'GSettingsFragmentData', 'backupTTL');
    BuiltValueNullFieldError.checkNotNull(
        backupTime, r'GSettingsFragmentData', 'backupTime');
    BuiltValueNullFieldError.checkNotNull(ip, r'GSettingsFragmentData', 'ip');
    BuiltValueNullFieldError.checkNotNull(
        port, r'GSettingsFragmentData', 'port');
    BuiltValueNullFieldError.checkNotNull(
        socksProxyEnabled, r'GSettingsFragmentData', 'socksProxyEnabled');
    BuiltValueNullFieldError.checkNotNull(
        socksProxyHost, r'GSettingsFragmentData', 'socksProxyHost');
    BuiltValueNullFieldError.checkNotNull(
        socksProxyPassword, r'GSettingsFragmentData', 'socksProxyPassword');
    BuiltValueNullFieldError.checkNotNull(
        socksProxyPort, r'GSettingsFragmentData', 'socksProxyPort');
    BuiltValueNullFieldError.checkNotNull(
        socksProxyUsername, r'GSettingsFragmentData', 'socksProxyUsername');
    BuiltValueNullFieldError.checkNotNull(
        socksProxyVersion, r'GSettingsFragmentData', 'socksProxyVersion');
    BuiltValueNullFieldError.checkNotNull(
        flareSolverrEnabled, r'GSettingsFragmentData', 'flareSolverrEnabled');
    BuiltValueNullFieldError.checkNotNull(flareSolverrSessionName,
        r'GSettingsFragmentData', 'flareSolverrSessionName');
    BuiltValueNullFieldError.checkNotNull(flareSolverrSessionTtl,
        r'GSettingsFragmentData', 'flareSolverrSessionTtl');
    BuiltValueNullFieldError.checkNotNull(
        flareSolverrTimeout, r'GSettingsFragmentData', 'flareSolverrTimeout');
    BuiltValueNullFieldError.checkNotNull(
        flareSolverrUrl, r'GSettingsFragmentData', 'flareSolverrUrl');
    BuiltValueNullFieldError.checkNotNull(
        debugLogsEnabled, r'GSettingsFragmentData', 'debugLogsEnabled');
    BuiltValueNullFieldError.checkNotNull(
        systemTrayEnabled, r'GSettingsFragmentData', 'systemTrayEnabled');
    BuiltValueNullFieldError.checkNotNull(
        gqlDebugLogsEnabled, r'GSettingsFragmentData', 'gqlDebugLogsEnabled');
    BuiltValueNullFieldError.checkNotNull(
        extensionRepos, r'GSettingsFragmentData', 'extensionRepos');
    BuiltValueNullFieldError.checkNotNull(
  ...
  @override
  GSettingsFragmentData rebuild(
          void Function(GSettingsFragmentDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GSettingsFragmentDataBuilder toBuilder() =>
      new GSettingsFragmentDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GSettingsFragmentData &&
        G__typename == other.G__typename &&
        backupInterval == other.backupInterval &&
        backupPath == other.backupPath &&
        backupTTL == other.backupTTL &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GSettingsFragmentData')
          ..add('G__typename', G__typename)
          ..add('backupInterval', backupInterval)
          ..add('backupPath', backupPath)
          ..add('backupTTL', backupTTL)
...
class GSettingsFragmentDataBuilder
    implements Builder<GSettingsFragmentData, GSettingsFragmentDataBuilder> {
  _$GSettingsFragmentData? _$v;
  ...
  GSettingsFragmentDataBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _G__typename = $v.G__typename;
      _backupInterval = $v.backupInterval;
  ...
  @override
  void replace(GSettingsFragmentData other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GSettingsFragmentData;
  }

  @override
  void update(void Function(GSettingsFragmentDataBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GSettingsFragmentData build() => _build();

  _$GSettingsFragmentData _build() {
    _$GSettingsFragmentData _$result;
    try {
      _$result = _$v ??
          new _$GSettingsFragmentData._(
              G__typename: BuiltValueNullFieldError.checkNotNull(
                  G__typename, r'GSettingsFragmentData', 'G__typename'),
              backupInterval: BuiltValueNullFieldError.checkNotNull(
                  backupInterval, r'GSettingsFragmentData', 'backupInterval'),
              ...
              backupTime: BuiltValueNullFieldError.checkNotNull(
                  backupTime, r'GSettingsFragmentData', 'backupTime'),
              ip: BuiltValueNullFieldError.checkNotNull(
                  ip, r'GSettingsFragmentData', 'ip'),
              port: BuiltValueNullFieldError.checkNotNull(
                  port, r'GSettingsFragmentData', 'port'),
              socksProxyEnabled: BuiltValueNullFieldError.checkNotNull(socksProxyEnabled, r'GSettingsFragmentData', 'socksProxyEnabled'),
              socksProxyHost: BuiltValueNullFieldError.checkNotNull(socksProxyHost, r'GSettingsFragmentData', 'socksProxyHost'),
              socksProxyPassword: BuiltValueNullFieldError.checkNotNull(socksProxyPassword, r'GSettingsFragmentData', 'socksProxyPassword'),
              socksProxyPort: BuiltValueNullFieldError.checkNotNull(socksProxyPort, r'GSettingsFragmentData', 'socksProxyPort'),
              socksProxyUsername: BuiltValueNullFieldError.checkNotNull(socksProxyUsername, r'GSettingsFragmentData', 'socksProxyUsername'),
              socksProxyVersion: BuiltValueNullFieldError.checkNotNull(socksProxyVersion, r'GSettingsFragmentData', 'socksProxyVersion'),
              flareSolverrEnabled: BuiltValueNullFieldError.checkNotNull(flareSolverrEnabled, r'GSettingsFragmentData', 'flareSolverrEnabled'),
              flareSolverrSessionName: BuiltValueNullFieldError.checkNotNull(flareSolverrSessionName, r'GSettingsFragmentData', 'flareSolverrSessionName'),
              flareSolverrSessionTtl: BuiltValueNullFieldError.checkNotNull(flareSolverrSessionTtl, r'GSettingsFragmentData', 'flareSolverrSessionTtl'),
              flareSolverrTimeout: BuiltValueNullFieldError.checkNotNull(flareSolverrTimeout, r'GSettingsFragmentData', 'flareSolverrTimeout'),
              flareSolverrUrl: BuiltValueNullFieldError.checkNotNull(flareSolverrUrl, r'GSettingsFragmentData', 'flareSolverrUrl'),
              debugLogsEnabled: BuiltValueNullFieldError.checkNotNull(debugLogsEnabled, r'GSettingsFragmentData', 'debugLogsEnabled'),
              systemTrayEnabled: BuiltValueNullFieldError.checkNotNull(systemTrayEnabled, r'GSettingsFragmentData', 'systemTrayEnabled'),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GSettingsFragmentData', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
