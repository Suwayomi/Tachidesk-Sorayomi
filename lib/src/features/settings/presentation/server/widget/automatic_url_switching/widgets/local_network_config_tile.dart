...
/// A list tile widget for displaying and managing local network configurations
class LocalNetworkConfigTile extends ConsumerWidget {
  const LocalNetworkConfigTile({
    super.key,
  ...
  final LocalNetworkConfig config;
  final int index;
