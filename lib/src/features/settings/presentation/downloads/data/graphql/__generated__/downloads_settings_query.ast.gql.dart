...
const UpdateDownloadsLocation = _i1.OperationDefinitionNode(
  type: _i1.OperationType.mutation,
  name: _i1.NameNode(value: 'UpdateDownloadsLocation'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'downloadsPath')),
...
const UpdateDownloadAsCbz = _i1.OperationDefinitionNode(
  type: _i1.OperationType.mutation,
  name: _i1.NameNode(value: 'UpdateDownloadAsCbz'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'downloadAsCbz')),
      type: _i1.NamedTypeNode(
...
const ToggleAutoDownloadNewChapters = _i1.OperationDefinitionNode(
  type: _i1.OperationType.mutation,
  name: _i1.NameNode(value: 'ToggleAutoDownloadNewChapters'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
...
const ToggleExcludeEntryWithUnreadChapters = _i1.OperationDefinitionNode(
  type: _i1.OperationType.mutation,
  name: _i1.NameNode(value: 'ToggleExcludeEntryWithUnreadChapters'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(
            ...
            _i1.ObjectFieldNode(
              ...
              value: _i1.ObjectValueNode(fields: [
                _i1.ObjectFieldNode(
                  ...
                  value: _i1.VariableNode(
                      name: _i1.NameNode(
                          value: 'excludeEntryWithUnreadChapters')),
                )
              ]),
            )
          ]),
...
const UpdateAutoDownloadNewChaptersLimit = _i1.OperationDefinitionNode(
  type: _i1.OperationType.mutation,
  name: _i1.NameNode(value: 'UpdateAutoDownloadNewChaptersLimit'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(
      ...
      defaultValue: _i1.DefaultValueNode(value: _i1.IntValueNode(value: '3')),
      directives: [],
    )
  ],
  directives: [],
            ...
            _i1.ObjectFieldNode(
              ...
              value: _i1.ObjectValueNode(fields: [
                _i1.ObjectFieldNode(
                  ...
                  value: _i1.VariableNode(
                      name:
                          _i1.NameNode(value: 'autoDownloadNewChaptersLimit')),
                )
              ]),
            )
          ]),
...
const document = _i1.DocumentNode(definitions: [
  ...
  UpdateDownloadAsCbz,
  ToggleAutoDownloadNewChapters,
  ToggleExcludeEntryWithUnreadChapters,
  UpdateAutoDownloadNewChaptersLimit,
  _i2.ServerSettings,
