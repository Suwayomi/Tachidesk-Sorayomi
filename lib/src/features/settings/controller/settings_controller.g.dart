...
String _$restoreStatusHash() => r'b70ecd1babf4571614aac6d917627ac647d1b3e3';
...
String _$automaticBackupSettingsHash() =>
    r'51be9c48a2309ba44fb4335deda56d2e4dd26b91';

/// See also [automaticBackupSettings].
@ProviderFor(automaticBackupSettings)
final automaticBackupSettingsProvider =
    AutoDisposeStreamProvider<AutomaticBackupSettingsDto?>.internal(
  automaticBackupSettings,
  name: r'automaticBackupSettingsProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$automaticBackupSettingsHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef AutomaticBackupSettingsRef
    = AutoDisposeStreamProviderRef<AutomaticBackupSettingsDto?>;
