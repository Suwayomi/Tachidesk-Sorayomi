...
part of 'manga_fragment.data.gql.dart';
      ...
      _$result = _$v ??
          new _$GMangaFragmentData_lastReadChapter._(
            ...
            sourceOrder: BuiltValueNullFieldError.checkNotNull(sourceOrder,
                r'GMangaFragmentData_lastReadChapter', 'sourceOrder'),
    ...
    try {
      _$result = _$v ??
          new _$GMangaFragmentData_latestFetchedChapter._(
            G__typename: BuiltValueNullFieldError.checkNotNull(G__typename,
                r'GMangaFragmentData_latestFetchedChapter', 'G__typename'),
            chapterNumber: BuiltValueNullFieldError.checkNotNull(chapterNumber,
                r'GMangaFragmentData_latestFetchedChapter', 'chapterNumber'),
            fetchedAt: fetchedAt.build(),
            id: BuiltValueNullFieldError.checkNotNull(
            ...
            pageCount: BuiltValueNullFieldError.checkNotNull(pageCount,
                r'GMangaFragmentData_latestFetchedChapter', 'pageCount'),
            realUrl: realUrl,
            scanlator: scanlator,
            sourceOrder: BuiltValueNullFieldError.checkNotNull(sourceOrder,
                r'GMangaFragmentData_latestFetchedChapter', 'sourceOrder'),
            uploadDate: uploadDate.build(),
            url: BuiltValueNullFieldError.checkNotNull(
                url, r'GMangaFragmentData_latestFetchedChapter', 'url'),
            meta: meta.build(),
    ...
    try {
      _$result = _$v ??
          new _$GMangaFragmentData_latestReadChapter._(
            G__typename: BuiltValueNullFieldError.checkNotNull(G__typename,
                r'GMangaFragmentData_latestReadChapter', 'G__typename'),
            chapterNumber: BuiltValueNullFieldError.checkNotNull(chapterNumber,
                r'GMangaFragmentData_latestReadChapter', 'chapterNumber'),
            fetchedAt: fetchedAt.build(),
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'GMangaFragmentData_latestReadChapter', 'id'),
            isBookmarked: BuiltValueNullFieldError.checkNotNull(isBookmarked,
                r'GMangaFragmentData_latestReadChapter', 'isBookmarked'),
            isDownloaded: BuiltValueNullFieldError.checkNotNull(isDownloaded,
                r'GMangaFragmentData_latestReadChapter', 'isDownloaded'),
            isRead: BuiltValueNullFieldError.checkNotNull(
                isRead, r'GMangaFragmentData_latestReadChapter', 'isRead'),
            lastPageRead: BuiltValueNullFieldError.checkNotNull(lastPageRead,
                r'GMangaFragmentData_latestReadChapter', 'lastPageRead'),
            lastReadAt: lastReadAt.build(),
            mangaId: BuiltValueNullFieldError.checkNotNull(
                mangaId, r'GMangaFragmentData_latestReadChapter', 'mangaId'),
            name: BuiltValueNullFieldError.checkNotNull(
                name, r'GMangaFragmentData_latestReadChapter', 'name'),
            pageCount: BuiltValueNullFieldError.checkNotNull(pageCount,
                r'GMangaFragmentData_latestReadChapter', 'pageCount'),
            realUrl: realUrl,
            scanlator: scanlator,
            sourceOrder: BuiltValueNullFieldError.checkNotNull(sourceOrder,
                r'GMangaFragmentData_latestReadChapter', 'sourceOrder'),
            uploadDate: uploadDate.build(),
            url: BuiltValueNullFieldError.checkNotNull(
                url, r'GMangaFragmentData_latestReadChapter', 'url'),
            meta: meta.build(),
      ...
      _$result = _$v ??
          new _$GMangaFragmentData_latestUploadedChapter._(
            ...
            mangaId: BuiltValueNullFieldError.checkNotNull(mangaId,
                r'GMangaFragmentData_latestUploadedChapter', 'mangaId'),
            name: BuiltValueNullFieldError.checkNotNull(
                name, r'GMangaFragmentData_latestUploadedChapter', 'name'),
            pageCount: BuiltValueNullFieldError.checkNotNull(pageCount,
                r'GMangaFragmentData_latestUploadedChapter', 'pageCount'),
            realUrl: realUrl,
            scanlator: scanlator,
            sourceOrder: BuiltValueNullFieldError.checkNotNull(sourceOrder,
                r'GMangaFragmentData_latestUploadedChapter', 'sourceOrder'),
